 ...
 * particular, you can set here the values of variables elements defined in euchreajm_euchreajm.tpl (elements
 ...
 */
  ...
  class view_euchreajm_euchreajm extends game_view
  {
    function getGameName() {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "euchreajm_euchreajm", "myblock" );
