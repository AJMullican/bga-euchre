...
////////////
    ...
    /*
        ...
        (note: each method below must match an input method in euchreajm.action.php)
    */
...
self::trace("AJM IN (stNextPlayer)  active player: " . $best_value_player_id . "----");
